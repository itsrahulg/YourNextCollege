...
const districtsByState = {
  Andhra_Pradesh: ['Anantapur', 'Chittoor', 'East Godavari', 'Guntur', 'Kadapa', 'Krishna', 'Kurnool', 'Nellore', 'Prakasam', 'Srikakulam', 'Visakhapatnam', 'Vizianagaram', 'West Godavari'],
Arunachal_Pradesh: ['Tawang', 'West Kameng', 'East Kameng', 'Papum Pare', 'Kurung Kumey', 'Kra Daadi', 'Lower Subansiri', 'Upper Subansiri', 'West Siang', 'East Siang', 'Siang', 'Upper Siang', 'Dibang Valley', 'Lower Dibang Valley', 'Anjaw', 'Lohit', 'Namsai', 'Changlang', 'Tirap'],
...
Jammu_and_Kashmir: ['Anantnag', 'Bandipora', 'Baramulla', 'Doda', 'Ganderbal', 'Jammu', 'Kathua', 'Kishtwar', 'Kulgam', 'Kupwara', 'Poonch', 'Pulwama', 'Rajouri', 'Ramban', 'Reasi', 'Samba', 'Shopian', 'Srinagar', 'Udhampur'],
Ladakh: ['Kargil', 'Leh']
...
statesList.addEventListener('change', function (event) {
    ...
    // Populate districts based on selected states
        ...
        if (districtsByState[selectedState]) {
          districtsByState[selectedState].forEach(district => {
            ...
            radio.type = 'radio';
            radio.name = 'district';
            radio.id = district; // Added id attribute
            radio.value = district;
        
            const label = document.createElement('label');
            label.classList.add('form-check-label');
            label.htmlFor = district; // Should match the id of the input
